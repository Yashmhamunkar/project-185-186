...
firebase = firebase.FirebaseApplication("https://console.firebase.google.com/project/encrypted-chat-e67ca/database/encrypted-chat-e67ca-default-rtdb/data/~2F", None)
